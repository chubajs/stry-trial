  ...
  try {
    ...
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'Вы - креативный писатель, который придумывает короткие и интересные названия для историй. Ваш ответ должен содержать только одну строку с названием, без кавычек или дополнительных пояснений.' },
